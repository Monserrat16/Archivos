			...
			<form method="POST" id="form-sesion">
				<div class="row">
					...
					<div class="input-field col s6">
						...
						<input id="contraseña" type="password" class="validate" maxlength="12" required>
						<label for="contraseña">Contraseña</label>
					</div>
				</div>
				<button class="btn waves-effect waves-light teal darken-4 right" type="submit" name="action" style="border-radius: 4px;" onclick="sesion_coordinador(); return false;">
					Iniciar ahora
